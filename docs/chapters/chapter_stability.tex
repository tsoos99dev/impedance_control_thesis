...
értékben egynél szigorúan kisebb legyen. A~\ref{fig:}. ábra a~\ref{tab:}. táblázat paraméterei alapján numerikusan 
...
\begin{figure}[ht]
    ...
    \caption{Diszkrét idejű stabilitástérkép}\label{fig:time_delay_stab_map}
    \end{center}
\end{figure}
