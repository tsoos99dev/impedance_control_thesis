...
\begin{equation}
    K_\RM c = \frac{R+k_3}{K_\RM m} - \frac{k_1}{K_\RM e}
\end{equation}
összefüggés szerint számolható, mely a szabályozott rendszer válasza végértékének a függvénye.
...
A rendszer átviteli függvénye a pozíció referencia jelet tekintve:
\begin{align}
...
ez az időkésés a rendszer beállási idejének legfeljebb 5\%-ára lesz korlátozva, szóval a pólus legfeljebb:
\begin{align}\label{eq:pole_selection_pos}
    p_\RM{max} = -\frac{1}{\frac{4}{\zeta \omega_0}} \div 5\% = -\frac{B_\RM e}{8M_\RM e} \div 5\%
\end{align}
...
\begin{align}
    -\frac{B_\RM e}{8p_\RM{min}} \div 5\% < M_\RM e < -0.1 \cdot Jp_\RM{min}\,,
\end{align}
...
\begin{align}
    B_\RM{e,max} = 25 \cdot Jp^2_\RM{min}\,,
\end{align}
...
\begin{figure}[ht]
    \begin{center}
    \includegraphics[width=\textwidth]{images/observer_controller_pos_resp_direct_comp_calib.png}
...
\begin{figure}[ht]
    \begin{center}
    \includegraphics[width=\textwidth]{images/observer_controller_torque_resp_direct_comp_calib.png}
