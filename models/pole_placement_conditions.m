...
fplot(subs(ilaplace(ds1/s), [L R J Km Bm Me Be Ke po], [0.2 1 0.01 0.01 0.1 1 4 16 -2]), [0 5])
hold on;
fplot(subs(ilaplace(impedance_model/s), [L R J Km Bm Me Be Ke po], [0.2 1 0.01 0.01 0.1 1 4 16 -2]), [0 5])
