...
A folytonos esethez hasonlóan, a stabilitásvizsgálat során a bemenetek értéke zérus a visszacsatolt szögelforduláson kívül.???
...
\begin{align}\label{eq:discrete_controller_matrices}
    ...
    \end{split}        
\end{align}
Behelyettesítve a szabályozó késleltetett kimenetét~\eqref{eq:discrete_controller_matrices} szerint:
% \begin{equation}
%     y[k+1] = \BF C\left[\BF A_\RM d\right]
%     \,.
% \end{equation}