...
A teljes stabilitástérkép felderítéséhez a beállási idő vizsgálata tűnt a legjobb paraméternek. Az \ref{fig:time_delay_stab_map_discrete_diff}. 
ábrához hasonlóan az új motorparaméterekkel meghatározott stabilitástérkép egy része látható a \ref{fig:stab_map_001}. ábrán.
...
A \ref{fig:stab_map_0005}. és \ref{fig:stab_map_00025}. ábrák a csökkenő időkésés hatását szemléltetik. 
A stabil tartomány megnövekszik és a relatív tartományok is eltolódnak, ami az alacsonyabb hibával rendelkező területek 
megnuovekedését eredményezik. Ez lehetővé tesz, azonos hiba mellett, egy gyorsabb rendszer működtetését. 
\begin{figure}[H]
    \begin{center}
...
a végső mérés 5 ms időkéséssel készült. A stabilitástérkép pontjai egy egyenletes 50x50-es rács segítségével fel lett 
osztva. Az így kapott 2500 potenciális mérési pont nagy rész vagy instabil, vagy a mérés kivitelezhetősége szempontjából 
...
együtt a mérési pontok teljes száma 992 pont volt. Minden mérési pont meghatároz egy impedancia modell beállítást, mely 
az \ref{fig:measurement_protocol}. ábrán is látható protokoll segítségével automatizált módon került át a szabályozót 
implementáló mikrovezérlőre. Minden mérés ideális esetben 10x lett megismételve, azonban ha az adott paraméterek mellett 
nem állt be a rendszer, 10 sikertelen próbálkozás után a következő mérésre ugrott a rendszer. Fellépett köztes eset is, 
...
a digitálsi rendszer az elvártnál gyorsabban áll be. 
